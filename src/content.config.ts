...
const workCollection = defineCollection({
  ...
  schema: z.object({
    ...
    romanizedTitle: z.string().nullable().optional(),
    titleNote: z.string().nullable().optional(),
    authors: z.array(z.string()),
    workType: z.string(),
    originalLanguage: z.string().nullable().optional(),
    publishedYearText: z.string().nullable().optional(),
    wikipediaTitle: z.string().nullable().optional(),
    wikipediaUrl: z.string().url().nullable().optional(),
    description: z.string(),
    descriptionParagraphs: z.array(z.string()).min(3),
