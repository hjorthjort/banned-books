...
| `wikipedia-books-banned-india` | partial | Large-scale seed source for nationwide and state-level government bans in India. | [Wikipedia: List of books banned in India](https://en.wikipedia.org/wiki/List_of_books_banned_in_India). Imported entries remain starter records until deeper sourcing is added. |
| `wikipedia-book-censorship-china` | partial | Seed source for mainland Chinese book bans and Cultural Revolution-era suppression. | [Wikipedia: Book censorship in China](https://en.wikipedia.org/wiki/Book_censorship_in_China). Used to broaden the non-Western corpus. |
| `wikipedia-book-censorship-iran` | partial | Seed source for Islamic Republic book bans and publication denials. | [Wikipedia: Book censorship in Iran](https://en.wikipedia.org/wiki/Book_censorship_in_Iran). Especially useful for Persian-language works listed with parenthetical English renderings. |
| `wikipedia-book-censorship-hong-kong` | partial | Large source page for post-2020 removals from Hong Kong public, school, and government-managed collections. | [Wikipedia: Book censorship in Hong Kong](https://en.wikipedia.org/wiki/Book_censorship_in_Hong_Kong). Used for a large non-Western import tranche with provisional English title renderings where needed. |
| `wikipedia-books-banned-new-zealand` | partial | Seed source for government classification, customs, and tribunal bans in New Zealand. | [Wikipedia: List of books banned in New Zealand](https://en.wikipedia.org/wiki/List_of_books_banned_in_New_Zealand). Used as a lower-priority backfill source after stronger non-Western import tranches were selected. |
